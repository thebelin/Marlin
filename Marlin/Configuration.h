...
#define STRING_CONFIG_H_AUTHOR "TheBelin"
...
#define CUSTOM_MACHINE_NAME "BLUEBUILDER"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 402, 320 }
